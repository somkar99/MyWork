...
/**
 * Created by Computer on 08-03-2018.
 */
class SelectWorkImages : AppCompatActivity() {
    ...
    fun initlayout(): Unit {
        ...
        if (position == null || position == 0) {
            ...
            lsExTitle = Uploadworkimages.uploadworkimages.get(position!! - 1).image_name!!
            lsExImageName = Uploadworkimages.uploadworkimages.get(position!! - 1).image!!
            //   liExSlNo =Uploadworkimages.uploadworkimages.get(position!!-1).imagesrno!!
            ...
            if (etTitle.text.toString().length > 0) {
                if (bmp != null) {
                    ...
                    for (i in 0..Uploadworkimages.uploadworkimages.size - 1) {
                        var lsTempTitle = Uploadworkimages.uploadworkimages.get(i).image_name
